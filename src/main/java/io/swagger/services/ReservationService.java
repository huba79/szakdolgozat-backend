 ...
 */
    ...
    public ReservationResponse addOne(ReservationMessage rMessage) 
       ...
       if( reservationRepo.isStageAvailable( postedReservation.getStageId(), 
            postedReservation.getDateFrom(), postedReservation.getDateTo() ,null).longValue() == 0L ) {            
    ...
    public ReservationResponse updateOne(Long reservationId, ReservationMessage rMessage) 
       ...
       if( reservationRepo.isStageAvailable(postedReservation.getStageId(), 
           postedReservation.getDateFrom(), postedReservation.getDateTo() ,reservationId) !=0L) {            
                       System.out.println("Validating put messagebody....OK");
