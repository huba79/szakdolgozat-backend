...
public class ReservationResponse implements Serializable{
    ...
    public ReservationResponse(Long reservationId, Long lakeId, Long userId, Long stageId, Date dateFrom, Date dateTo, String status, List<OrderedItems> orderedItems, Payment payment) {
